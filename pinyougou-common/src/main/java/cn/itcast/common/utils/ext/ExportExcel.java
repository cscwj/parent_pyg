package cn.itcast.common.utils.ext;
...
//   * 功能: 导出为Excel工作簿
//   *
//   * @param sheetName sheetName[工作簿中的一张工作表的名称]
//   * @param titleName titleName[表格的标题名称]
//   * @param headers   headers[表格每一列的列名]
//   * @param dataSet   dataSet[要导出的数据源]
//   * @param resultUrl resultUrl[导出的excel文件地址]
//   * @param pattern   pattern[时间类型数据的格式]
//   */
...
//作者：汝非良人
//来源：CSDN
//原文：https://blog.csdn.net/jml1437710575/article/details/52051278
